...
void main() {
  runApp(MaterialApp(
    title: "creativecreatorormaybenot's particle playground",
...
class _PainterWidgetState extends State<PainterWidget> {
  ...
  late List<List<Object>> _configurables;
...
class Painter extends CustomPainter {
  ...
  static double _destinationPadding = 124;

  /// Position of the particles.
  double _x = 0, _y = 0;

  /// All information about all particles.
  late List<List<double>> _particles;
